...
void IntersectionUI::draw() {
    ...
    //Call HitRecord hr = intersect(pE1, dir);     //drawHits(hr);
...
void IntersectionUI::changeShape( ShapesUI::ShapeType type )
{
    ...
    case ShapesUI::SHAPE_SPHERE : 
		currentShape = new Sphere(t1);
		break;
    case ShapesUI::SHAPE_CYLINDER : 
		currentShape = new Cylinder(t1, t2);
		break;
    case ShapesUI::SHAPE_CONE : 
		currentShape = new Cone(t1, t2);
		break;
    case ShapesUI::SHAPE_CUBE : 
		currentShape = new Cube(t1);
		break;
	case ShapesUI::SHAPE_TORUS:
		currentShape = new Torus(t1, t2);
		break;
    }
}
